...
# Full chat log is still shown on screen...
...
if user_input:
    ...
    # ...but only THIS message is sent to the model. No history.
    # The model has zero memory of anything said earlier.
    with st.chat_message("assistant"):
        reply = ask([{"role": "user", "content": user_input}], system_prompt)
        st.markdown(reply)
